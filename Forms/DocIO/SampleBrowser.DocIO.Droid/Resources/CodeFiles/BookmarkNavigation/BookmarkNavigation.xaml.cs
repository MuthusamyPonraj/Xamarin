...
namespace SampleBrowser.DocIO
{
    public partial class BookmarkNavigation : SampleView
    {
        ...
        void OnButtonClicked(object sender, EventArgs e)
        {
            ...
            Stream inputStream = assembly.GetManifestResourceStream("SampleBrowser.DocIO.Samples.Templates.Bookmark_Template.doc");
            ...
            inputStream = assembly.GetManifestResourceStream("SampleBrowser.DocIO.Samples.Templates.BkmkDocumentPart_Template.doc");
            // Open an existing template document.
            ...
            inputStream = assembly.GetManifestResourceStream("SampleBrowser.DocIO.Samples.Templates.Northwind.png");
