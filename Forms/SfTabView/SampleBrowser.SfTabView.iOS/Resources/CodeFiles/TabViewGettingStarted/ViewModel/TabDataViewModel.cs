...
namespace SampleBrowser.SfTabView
{
    internal class TabDataViewModel
    {
        ...
        {
            ImageCollection.Add("sofa2.png");
            ImageCollection.Add("hall.png");
            ImageCollection.Add("sofa.png");
            ImageCollection.Add("chair.png");
            ImageCollection.Add("hall2.png");
            ImageCollection.Add("whiteshirt.png");
            ImageCollection.Add("shirt.png");
            ImageCollection.Add("tshirt.png");
            ImageCollection.Add("redcoat.png");
            ImageCollection.Add("silvercoat.png");
            ImageCollection.Add("canvas.png");
            ImageCollection.Add("graycanvas.png");
            ImageCollection.Add("boots.png");
            ImageCollection.Add("blackshoe.png");
            ImageCollection.Add("leather.png");
            ImageCollection.Add("orange.png");
            ImageCollection.Add("blueberry.png");
            ImageCollection.Add("apple.png");
            ImageCollection.Add("strawberry.png");
            ImageCollection.Add("banana.png");
            ImageCollection.Add("friends.png");
            ImageCollection.Add("robot.png");
            ImageCollection.Add("minion.png");
            ImageCollection.Add("train.png");
            ImageCollection.Add("van.png");
