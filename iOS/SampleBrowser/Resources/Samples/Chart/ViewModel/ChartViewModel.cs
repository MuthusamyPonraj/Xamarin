	...
	public class ChartViewModel
	{
		...
		public ChartViewModel()
		{
            ...
            AxisCrossingData = new ObservableCollection<ChartDataModel>()
            {
                ...
                new ChartDataModel(dt.AddMonths(4), 70,5),
                new ChartDataModel(dt.AddMonths(8), 50,8),
                new ChartDataModel(dt.AddMonths(12), -30,5),
                new ChartDataModel(dt.AddMonths(16), -70,10),
                new ChartDataModel(dt.AddMonths(20), 40,12),
                new ChartDataModel(dt.AddMonths(24), 80,13),
                new ChartDataModel(dt.AddMonths(28), -70,6),
                new ChartDataModel(dt.AddMonths(32), 30,8),
                new ChartDataModel(dt.AddMonths(36), 80,3),
                new ChartDataModel(dt.AddMonths(40), -30,5),
                new ChartDataModel(dt.AddMonths(44), -80,7),
                new ChartDataModel(dt.AddMonths(48), 40,3),
                new ChartDataModel(dt.AddMonths(52), -50,8),
                new ChartDataModel(dt.AddMonths(56), -10,4),
                new ChartDataModel(dt.AddMonths(60), -80,9),
                new ChartDataModel(dt.AddMonths(64), 40,10),
                new ChartDataModel(dt.AddMonths(68), -50,6),
