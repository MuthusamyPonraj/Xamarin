    ...
    public class PopupGettingStarted : SamplePage
    {
        ...
        private void BackgroundView_Click(object sender, EventArgs e)
        {
            ...
            if (clickCount == 1)
            {
                ...
                sfPopUp.Show((int)((cont.Resources.DisplayMetrics.WidthPixels / 2) - (75 * density)), 0);
                sfPopUp.StaysOpen = true;
                img = null;
                linear = null;
            }
            ...
            else if (clickCount == 3)
            {
                ...
                sfPopUp.PopupView.ContentView = linear;
                sfPopUp.StaysOpen = true;
                var point = this.sfGrid.RowColumnIndexToPoint(new Syncfusion.GridCommon.ScrollAxis.RowColumnIndex(3, 0));
                sfPopUp.Show((int)(point.X + (5 * density)), (int)(point.Y + (5 * density)));
                img = null;
                linear = null;
            }
            else if (clickCount == 4)
            {
                ...
                sfPopUp.StaysOpen = true;
                var point = this.sfGrid.RowColumnIndexToPoint(new Syncfusion.GridCommon.ScrollAxis.RowColumnIndex(3, 0));
                sfPopUp.Show((int)(point.X + (10 * density)), (int)(point.Y + (5 * density)));
                img = null;
                img2 = null;
                linear = null;
            }
