...
namespace SampleBrowser
{
    ...
    public class Trackball : SamplePage
    {
        ...
        public override View GetSampleContent(Context context)
        {
			...
			chart.PrimaryAxis.PlotOffset = 5;
			chart.PrimaryAxis.AxisLineOffset = 2;
			...
			series.DataMarker.MarkerColor = Color.ParseColor("#00BDAE");
			...
			series.DataMarker.MarkerColor = Color.ParseColor("#404041");
            series.DataMarker.ShowMarker = true;
            series.DataMarker.MarkerStrokeColor = Color.White;
            series.DataMarker.MarkerStrokeWidth = 2;
			series.DataMarker.MarkerWidth = 10;
			...
			series.DataMarker.MarkerColor = Color.ParseColor("#357CD2");
            series.DataMarker.ShowMarker = true;
            series.DataMarker.MarkerStrokeColor = Color.White;
            series.DataMarker.MarkerStrokeWidth = 2;
			series.DataMarker.MarkerWidth = 10;
