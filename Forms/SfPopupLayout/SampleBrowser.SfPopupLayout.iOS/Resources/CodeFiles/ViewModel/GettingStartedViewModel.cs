    ...
    public class ContactsViewModel : INotifyPropertyChanged
    {
        ...
        public ContactsViewModel()
        {
            ...
            foreach (var cusName in CustomerNames)
            {
                ...
                contact.PhoneImage = ImageSource.FromResource("SampleBrowser.SfPopupLayout.Images.PhoneImage.png");
                contact.ContactImage = ImageSource.FromResource("SampleBrowser.SfPopupLayout.Images.Image" + counter + ".png");
