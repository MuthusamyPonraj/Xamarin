...
namespace SampleBrowser
{
	...
	public class AllControlsCollectionDelegate : UICollectionViewDelegate
	{
		...
		public override void ItemSelected(UICollectionView collectionView, NSIndexPath indexPath)
		{
            ...
            //Present intermediate screen when the sample count is above 4
            if (ctrl.name == "Chart")
            {
                AllSamplesViewController sampleController = new AllSamplesViewController();
                sampleController.FeaturesCollections = collections;
                //sampleController.Samples = samplesArray;
                //sampleController.DisplayNamesCollections = dispNames;
                sampleController.ControlName = contrl.name;
                sampleController.IsMultipleSampleView = contrl.IsMultipleSampleView;
                sampleController.Type1 = contrl.Type1;
                sampleController.Type2 = contrl.Type2;
