...
namespace SampleBrowser.SfCarousel
{
	public partial class Carousel_Default : SampleView
	{
		...
		internal List<CarouselModel> GetDataSource()
		{
			...
			{
				list.Add(new CarouselModel(ImagePathConverter.GetImageSource("SampleBrowser.SfCarousel.carousel_person1.png")));
				list.Add(new CarouselModel(ImagePathConverter.GetImageSource("SampleBrowser.SfCarousel.carousel_person2.png")));
				list.Add(new CarouselModel(ImagePathConverter.GetImageSource("SampleBrowser.SfCarousel.carousel_person3.png")));
				list.Add(new CarouselModel(ImagePathConverter.GetImageSource("SampleBrowser.SfCarousel.carousel_person4.png")));
				list.Add(new CarouselModel(ImagePathConverter.GetImageSource("SampleBrowser.SfCarousel.carousel_person5.png")));
			}
			else
			{
