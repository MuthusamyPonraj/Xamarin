        ...
        private void leftImage_BindingContextChanged(object sender, EventArgs e)
        {
            if (leftImage.Source == null)
            {
                ...
                if (Device.RuntimePlatform == Device.Android)
                 ...
                 leftImage.Source = ImageSource.FromResource("SampleBrowser.SfDataGrid.Icons.DataGrid.SwipingIcon_iOS_Edit.png");
                else
                leftImage.Source = ImageSource.FromResource("SampleBrowser.SfDataGrid.Icons.DataGrid.SwipingIcon_UWP_Edit.png");
         }
        }
        ...
        private void rightImage_BindingContextChanged(object sender, EventArgs e)
        {
            if (rightImage.Source == null)
            {
                ...
                if (Device.RuntimePlatform == Device.Android)
                    ...
                    rightImage.Source = ImageSource.FromResource("SampleBrowser.SfDataGrid.Icons.DataGrid.SwipingIcon_iOS_Delete.png");
else
                   rightImage.Source = ImageSource.FromResource("SampleBrowser.SfDataGrid.Icons.DataGrid.SwipingIcon_UWP_Delete.png");
            }
        }
