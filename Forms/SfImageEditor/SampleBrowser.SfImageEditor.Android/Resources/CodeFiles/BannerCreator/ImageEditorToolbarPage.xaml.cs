    ...
    public partial class ImageEditorToolbarPage : ContentPage
    {
        ...
        public ImageEditorToolbarPage(ImageSource imagesource, ViewModel viewModel, Model model)
        {
            ...
            FooterToolbarItem banner = new FooterToolbarItem()
            {
                ...
                {
                    new Syncfusion.SfImageEditor.XForms.ToolbarItem(){Text="Facebook Post",Icon=ImageSource.FromResource("SampleBrowser.SfImageEditor.Icons.fivetofour.png")},
                    new Syncfusion.SfImageEditor.XForms.ToolbarItem(){Text="Facebook Cover",Icon=ImageSource.FromResource("SampleBrowser.SfImageEditor.Icons.fourtothree.png")},
                    new Syncfusion.SfImageEditor.XForms.ToolbarItem(){Text="Twitter Cover",Icon=ImageSource.FromResource("SampleBrowser.SfImageEditor.Icons.fivetofour.png")},
                    new Syncfusion.SfImageEditor.XForms.ToolbarItem(){Text="Twitter Post",Icon=ImageSource.FromResource("SampleBrowser.SfImageEditor.Icons.fourtothree.png")},
                    new Syncfusion.SfImageEditor.XForms.ToolbarItem(){Text="YouTubeChannel Cover",Icon=ImageSource.FromResource("SampleBrowser.SfImageEditor.Icons.fivetofour.png")},
