...
namespace SampleBrowser
{
	public class Configuration : SamplePage
	{
		...
		{
			sfschedule.DayViewSettings.WorkStartHour = (int)e.RangeStart;
			sfschedule.DayViewSettings.WorkEndHour = (int)e.RangeEnd;
			sfschedule.WeekViewSettings.WorkStartHour = (int)e.RangeStart;
			sfschedule.WeekViewSettings.WorkEndHour = (int)e.RangeEnd;
			sfschedule.WorkWeekViewSettings.WorkStartHour = (int)e.RangeStart;
			sfschedule.WorkWeekViewSettings.WorkEndHour = (int)e.RangeEnd;
		}
