...
namespace SampleBrowser
{
	...
	public class FeaturesTabbedPage : Activity
	{
		public FeaturesTabbedPage()
		{
		}
		...
		protected override void OnCreate(Bundle bundle)
		{
			...
			if ((SelectedGroup as Group).Features.Count > 0)
			{
				...
				AddTab("Types", new TypesFragment((SelectedGroup as Group).samples,this));

				AddTab("Features", new FeaturesFragment((SelectedGroup as Group).Features,this));
			}
			else
			{
			...
			if (bundle != null && ActionBar.TabCount>0)
