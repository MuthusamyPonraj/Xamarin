...
namespace SampleBrowser.SfImageEditor
{
    public partial class SerializationContentPage : ContentPage
    {
        ...
        void ImageEditor_ImageSaving(object sender, Syncfusion.SfImageEditor.XForms.ImageSavingEventArgs args)
        {
            ...
            if (SelectedItem.ImageName == "CreateNew")
            {
                mainModel.ModelList.Add(new SerializationModel
                {
                    ...
                    SelectionImage = ImageSource.FromResource("SampleBrowser.SfImageEditor.Icons.NotSelected.png"),
        ...
        public SerializationContentPage(SerializationModel selectedItem, SfListView listView, SerializationViewModel model)
        {
            InitializeComponent();
            mainModel = model;
            ...
            {
                imageEditor.Source = ImageSource.FromResource("SampleBrowser.SfImageEditor.Icons.Plain.png");
            }
