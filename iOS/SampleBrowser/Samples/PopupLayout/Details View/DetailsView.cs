...
namespace SampleBrowser
{
    ...
    public class PopupContactCell : UITableViewCell
    {
		...
		public override void TouchesEnded(NSSet touches, UIEvent evt)
		{
			...
			DetailsView.popupLayout.PopupView.PopupStyle.BorderThickness = 0;
			DetailsView.popupLayout.PopupView.ShowHeader = false;
			DetailsView.popupLayout.PopupView.ShowFooter = false;

			if (this.Frame.Bottom + 150 <= this.Superview.Frame.Bottom)
			{
				if (Math.Abs((this.Frame.Bottom - 3 + 150) - this.Superview.Frame.Bottom) <= 3)
					DetailsView.popupLayout.PopupView.Frame = new CGRect(-1, -1, this.Frame.Width - Label4.Frame.Width - 5, 140);
				else
					DetailsView.popupLayout.PopupView.Frame = new CGRect(-1, -1, this.Frame.Width - Label4.Frame.Width - 5, 150);
				DetailsView.popupLayout.PopupView.ContentView = GetCustomPopupView();
				DetailsView.popupLayout.Show(imageView1.Frame.X - 10, this.Frame.Bottom - 25);
			}
			else
			{
				DetailsView.popupLayout.PopupView.Frame = new CGRect(-1, -1, this.Frame.Width - Label4.Frame.Width - 5, 150);
				DetailsView.popupLayout.PopupView.ContentView = GetCustomPopupView();
				DetailsView.popupLayout.Show(imageView1.Frame.X - 10, this.Frame.Bottom - 95);
		...
		void DisplayToast(UITapGestureRecognizer tasture)
		{
			...
			DetailsView.popupLayout.Content.AddSubview(overlayTags);
			overlayTags.Frame = new CGRect((DetailsView.popupLayout.Frame.Right / 2) - 100 , DetailsView.popupLayout.Frame.Bottom - 20, 200, 40);
