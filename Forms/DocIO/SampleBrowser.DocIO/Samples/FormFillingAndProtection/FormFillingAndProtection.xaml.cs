...
namespace SampleBrowser.DocIO
{
    ...
    public partial class FormFillingAndProtection : SampleView
    {
        ...
        private void OnButtonClicked(object sender, EventArgs e)
        {
            ...
            Stream inputStream = typeof(FormFillingAndProtection).GetTypeInfo().Assembly.GetManifestResourceStream("SampleBrowser.DocIO.Samples.Templates.ContentControlTemplate.docx");
