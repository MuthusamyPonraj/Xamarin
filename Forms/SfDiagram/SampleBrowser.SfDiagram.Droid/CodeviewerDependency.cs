...
namespace SampleBrowser.SfDiagram.Droid
{
    class Text : IText
    {
        public object GetTextView(string name , float width)
        {
            ...
            labelAnnotation.SetTextSize(Android.Util.ComplexUnitType.Px, 14 * App.factor);
            labelAnnotation.Gravity = Android.Views.GravityFlags.Center;
            labelAnnotation.SetTextColor(Android.Graphics.Color.Black);
        ...
        public void GenerateFactor()
        {
            ...
            float deviceDenstiy = Forms.Context.Resources.DisplayMetrics.Density;
