...
namespace SampleBrowser
{
    public class CustomSearchRenderer:SearchBarRenderer
    {
        ...
        protected override void OnElementPropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
			...
			UIBarButtonItem.AppearanceWhenContainedIn(typeof(UISearchBar)).SetTitleTextAttributes(new UITextAttributes() { TextColor = UIColor.FromRGB(0, 125, 230) }, UIControlState.Normal);
