	...
	public class SampleViewController : UIViewController
	{
		...
		void OpenOptionView(object sender, EventArgs ea)
		{
			...
			else
			{
				...
				CGRect frame = new CGRect(view.Frame.X + 5, view.Frame.Y + 2 + (view.Frame.Height / 2), view.Frame.Width, view.Frame.Height);

				popover.PresentFromRect(frame, this.View, UIPopoverArrowDirection.Any, true);
			}
		}
