	...
	public class PopupGettingStarted : SampleView
	{
        ...
        void NextButton_TouchDown(object sender, EventArgs e)
        {
            ...
            if (clickCount == 1)
            {
                ...
                sfPopUp.PopupView.Frame = new CGRect(this.Frame.Width / 2 - 60, 0, 190, 130);
                hostingView.Frame = new CGRect(sfPopUp.PopupView.Frame.Left, sfPopUp.PopupView.Frame.Top, 160, 130);
                imageView.Frame = new CGRect(0, hostingView.Frame.Top, 130, 130);
            ...
            else if (clickCount == 3)
            {
                ...
                sfPopUp.PopupView.Frame = new CGRect(point.X - 10, point.Y - 10, 300, 150);
                hostingView.Frame = new CGRect(sfPopUp.PopupView.Frame.Left, sfPopUp.PopupView.Frame.Top, 300, 120);
                imageView.Frame = new CGRect(0, 0, 200, 120);
                hostingView.AddSubview(imageView);
                sfPopUp.PopupView.ContentView = hostingView;
                sfPopUp.IsOpen = true;
            }
		...
		{
			sfPopUp.PopupView.Frame = new CGRect(this.sfPopUp.Frame.Width - 25, 0, 150, 70);
			sfPopUp.Show();
		}
		...
		private void CreatePopup()
		{
			...
			//sfPopUp.PopupView.AppearanceMode = AppearanceMode.Custom;
        ...
        private void BackgroundViewPressed(UITapGestureRecognizer tapGesture)
		{
            ...
            else if (clickCount == 3)
            {
                ...
                var point = this.SfGrid.RowColumnIndexToPoint(new Syncfusion.GridCommon.ScrollAxis.RowColumnIndex(4, 0));
                sfPopUp.PopupView.Frame = new CGRect(point.X - 10, point.Y - 10, 300, 150);
                hostingView.Frame = new CGRect(sfPopUp.PopupView.Frame.Left, sfPopUp.PopupView.Frame.Top, 300, 150);
                imageView.Frame = new CGRect(0, 0, 200, 150);
                hostingView.AddSubview(imageView);
                sfPopUp.PopupView.ContentView = hostingView;
                sfPopUp.IsOpen = true;
            }
