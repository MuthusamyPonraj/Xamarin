...
            } 
            ...
            imageButton.Source = ImageSource.FromResource("PatientMonitor.Images.Clock_128.png");
        ...
        private void TapGesture_Tapped(object sender, EventArgs e)
        {
            if (buttonClickValue == 0)
            {
                ...
                imageButton.Source = ImageSource.FromResource("PatientMonitor.Images.Audip_128.png");
                buttonClickValue++;
            }
            else
            {
