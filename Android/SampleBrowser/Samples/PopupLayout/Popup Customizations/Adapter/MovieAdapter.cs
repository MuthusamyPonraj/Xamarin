...
namespace SampleBrowser
{
    public class MovieAdapter : BaseAdapter<TableItem>
    {
        ...
        private LinearLayout CreateMovieTile (LinearLayout view,TableItem item)
        {
            ...
            b.SetTextSize(ComplexUnitType.Dip, 14);
            b.Gravity = GravityFlags.Center;
            b.SetY((int)(43 *density));
            //b.SetForegroundGravity(GravityFlags.CenterHorizontal);
            if (MainActivity.isTablet)
                b.SetPadding(0, 0, (int)(12 * density), 0);
            else
                b.SetPadding((int)(12 * density), 0, (int)(12 * density), 0);
            b.SetText("Book", TextView.BufferType.Normal);
            b.SetBackgroundColor(Color.ParseColor("#007CEE"));
            b.Click += B_Click;
            if (MainActivity.isTablet)
                view.AddView(b, (int)(65 * density), (int)(30 * density));
            else
                view.AddView(b, (int)(60 * density), (int)(30 * density));
            return view;
        }
        ...
        private void B_Click(object sender, EventArgs e)
        {
            ...
            var backbutton = ((((context as FeaturesTabbedPage).SettingsButton.Parent as RelativeLayout).GetChildAt(1) as LinearLayout).GetChildAt(0) as RelativeLayout).GetChildAt(0);
