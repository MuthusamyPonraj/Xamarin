...
namespace SampleBrowser
{
    ...
    public class MainPage
    {
        ...
        {
            var datas = new List<DataPoint>();
            datas.Add(new DataPoint(2000, 40));
            datas.Add(new DataPoint(2001, 60));
            datas.Add(new DataPoint(2002, 50));
            datas.Add(new DataPoint(2003, 55));
            datas.Add(new DataPoint(2004, 75));
            datas.Add(new DataPoint(2005, 80));
            return datas;
        }
        ...
        {
            var datas = new List<DataPoint>();
            datas.Add(new DataPoint(2000, 20));
            datas.Add(new DataPoint(2001, 40));
            datas.Add(new DataPoint(2002, 30));
            datas.Add(new DataPoint(2003, 45));
            datas.Add(new DataPoint(2004, 55));
            datas.Add(new DataPoint(2005, 60));
            return datas;
        }
        ...
        {
            var datas = new List<DataPoint>();
            datas.Add(new DataPoint("Chorme", 94658));
            datas.Add(new DataPoint("UC Browser", 9090));
            datas.Add(new DataPoint("Opera", 2577));
            return datas;
        }
    ...
    public class Data
    {
        ...
        {
            var datas = new List<DataPoint>();
            datas.Add(new DataPoint("BGD", 87));
            datas.Add(new DataPoint("BTN", 70));
            datas.Add(new DataPoint("NPL", 82));
            datas.Add(new DataPoint("THA", 75));
            datas.Add(new DataPoint("MYS", 90));
            return datas;
        }
